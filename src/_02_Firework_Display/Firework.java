...
public class Firework {
	...
	// 1. Create an array of Spark objects called sparks. Don't initialize it.Spark
	// sparks[];
	...
	public Firework() {
		...
		// 3. Iterate through the sparks and initialize each one to a new Spark. Make
		// each spark start at the middle bottom of the screen.
	...
	public void launch() {
		// 4. Iterate through the sparks and reset their x and y location to their original starting point.
		for (int i = 0; i < sparks.length; i++) {
			sparks[i] = new Spark(720, 720);
		}
	}
